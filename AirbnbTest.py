    ...
    def testVienna(self):
        ...
        def allOffers():
            ...
            for offers in list(range(numberOfAllOffers)):
                listing = driver.find_element_by_xpath("(%s//div[@class='_19cnn6tn'])[%s]" % (xpathAllOffers, (offers + 1)))
        ...
        def allSuperhosts(element):
            ...
            for superhost in list(range(numberOfSuperhosts)):
                xpathSuperhost = "//span[text()='Superhost']//parent::span//parent::div//parent::div//parent::div//parent::a"
        ...
        def goForwardAndBack(number=1):
            for i in range(number):
                ...
                hostButton.click()
                hostaHomeButton = driver.find_element_by_xpath("(//li//a)[1]")
        ...
        datesButton = driver.find_element_by_xpath("//span[text()='Dates']/parent::div/parent::button")
        datesButton.click()
        time.sleep(1)

        checkInDate = driver.find_element_by_xpath("//div/div[3]//tr[2]/td[2]")
        checkInDate.click()
        checkOutDate = driver.find_element_by_xpath("//div/div[3]//tr[2]/td[5]")
        checkOutDate.click()
